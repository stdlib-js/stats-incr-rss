...
```javascript
incrrss = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-rss@v0.2.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/stats-incr-rss/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/stats-incr-rss/actions/workflows/test.yml?query=branch:v0.2.1
